...
if (!isset($_GET['id_alternatif']) || !is_numeric($_GET['id_alternatif'])) {
  die("ID alternatif tidak valid.");
}
$id = (int) $_GET['id_alternatif'];
		...
		<div class="container form-container">
		  <section class="bg-white border rounded p-4 shadow-sm">
			<div class="mb-4 border-bottom pb-2">
			  <h5 class="text-primary"><i class="fas fa-edit me-2"></i>Edit Alternatif</h5>
			</div>
			<form action="aksi_edit_alternatif.php" method="POST">
			  ...
			  <div class="mb-3">
				...
				<input type="text" name="nama" class="form-control" value="<?= htmlspecialchars($row['nama_alternatif']) ?>" required>
			  </div>
